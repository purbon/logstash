...
describe LogStash::FilterDelegator do
  ...
  let(:slow_logger) { LogStash::SlowLog.new }
  ...
  subject { described_class.new(logger, plugin_klass, metric, slow_logger, config) }
  ...
  it "create a plugin with the passed options" do
    ...
    described_class.new(logger, plugin_klass, metric, slow_logger, config)
  end
